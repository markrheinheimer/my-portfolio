...
// Data
const account1 = {
  owner: 'Mark Rheinheimer',
  movements: [3000, -650, -130, 70, 1300],
  interestRate: 1.2, // %
  pin: 1111,
};
...
const account2 = {
  owner: 'Jane Doe',
  movements: [3400, -150, -790, -1000, 8500, -30],
  interestRate: 1.5,
  pin: 2222,
};
...
const account3 = {
  owner: 'Mike Jones',
  movements: [200, -200, 340, -20, 50, 400],
  interestRate: 0.7,
  pin: 3333,
};
...
btnClose.addEventListener('click', function (e) {
  ...
  // Reset values and remove welcome message
...
function displayTimer() {
  if (sec === 0 && min === 0) {
    ...
    labelTimer.innerText = `${min}:0${sec}`;
    min--;
    sec = 59;
  } else if (sec < 10) {
    labelTimer.innerText = `${min}:0${sec}`;
